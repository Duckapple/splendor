...
<button
	class={'flex flex-col justify-between w-14 h-[5.5rem] first:mt-0 transition-transform rounded-lg border border-black select-none md:w-32 md:h-48 md:text-3xl shadow-lg aspect-square bg-gradient-to-br outline-offset-4 focus:outline outline-blue-500 ' +
		gradientOf[c]}
...
>
	<div
		class={'md:py-0.5 px-1 md:px-2 text-3xl md:text-6xl md:card-pattern rounded-t-lg text-left ' +
			bgColorOf[c]}
	>
